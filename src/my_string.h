...
constexpr std::size_t CAPACITY_INCREASE_FACTOR_STRING = 2;
...
public:
	...
	using const_iterator = random_access_iterator<const char>;
	...
	[[nodiscard]] const_iterator cbegin() const noexcept { return const_iterator(m_elem); }
	...
	[[nodiscard]] const_iterator cend() const noexcept { return const_iterator(m_elem + m_size); }
...
private:
	...
	{
		return m_capacity * CAPACITY_INCREASE_FACTOR_STRING + 1;
	}
